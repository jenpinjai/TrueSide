...
public final class BathToText {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Negative value of -1257.5463 : " + new BathToText().getText(-1257.00));
        System.out.println("Positive value of 1234.5463 : " + new BathToText().getText(1234.54));
        System.out.println("Negative string value of -1,234.5463 : " + new BathToText().getText("-1,234.54"));
        System.out.println("Positive string value of 1,234.5463 : " + new BathToText().getText("11,561,231.54"));
    }
