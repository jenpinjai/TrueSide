...
public class CheckBillPrintInfo {
	//CheckBillPrintInfo_sh 1 12 2016 /home/appadm/var/tea/MigData/ListAccount/Cycle1.txt
	public static void main(String[] args) throws Exception {
		...
		for(int i=0;i<BanList.size();i++){
			...
			Sql11g.getBILL_PRINT_INFO(conn11g, CYCLE_CODE, CYCLE_MONTH, CYCLE_YEAR, BanList.get(i), stBILL_PRINT_INFO11g);
