...
public class IcRatesAddlInfoPK  implements Serializable {
    
    /** Creates a new instance of IcRatesAddlInfo */
    public IcRatesAddlInfoPK(
            String ratePlanCd	
    ...
    public String toString() {
        return super.toString() + " " + ratePlanCd + " " + destinationCd + " " + chrgParamId + " " + qualParam1Id + " " + qualParam1Cd + " " + qualParam2Id + " " + qualParam2Cd + " " + qualParam3Id + " " + qualParam3Cd + " " + qualParam4Id + " " + qualParam4Cd + " " + qualParam5Id + " " + qualParam5Cd + " " + qualParam6Id + " " + qualParam6Cd + " " + qualParam7Id + " " + qualParam7Cd + " " + effectiveDate;
    }
