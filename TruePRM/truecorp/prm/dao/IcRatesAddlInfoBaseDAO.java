...
public class IcRatesAddlInfoBaseDAO extends SystemBaseDao{
    ...
    public int insert( IcRatesAddlInfo icRatesAddlInfo) throws SQLException {
	...
	SQL_STATEMENT += "values ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        try {
            ...
            try{ logWriter.write("Insert IcRatesAddlInfo fail:"+icRatesAddlInfo.getDestinationCd()+"\t "+icRatesAddlInfo.getRatePlanCd()+"\r\n"); } catch(Exception ex2){}
    ...
    public int update( IcRatesAddlInfo icRatesAddlInfo) throws SQLException {
        PreparedStatement stmt = null;
    ...
    public int expireDestinationCd(String destinationCd,java.util.Date expireDate) throws SQLException {
        Statement stmt = null;
        String SQL_STATEMENT ="update IC_RATES_ADDL_INFO set EXPIRATION_DATE = TO_DATE('"+new SimpleDateFormat("dd-MM-yyyy HH:mm:ss",Locale.US).format(expireDate)+"', 'dd-mm-yyyy HH24:MI:SS') "
    ...
    public int delete( IcRatesAddlInfo icRatesAddlInfo) throws SQLException {
        PreparedStatement stmt = null;
    ...
    public List findByAccesChrgSeq( java.math.BigDecimal accesChrgSeq) throws SQLException {
        PreparedStatement stmt = null;
        ResultSet rs = null;
...
/*    
    ...
    public List findByCriteriaOR( IcRatesAddlInfo criteria) throws SQLException {
        PreparedStatement stmt = null;
        ResultSet rs = null;
        String SQL_STATEMENT = "";
...
*/
    ...
    public List<IcRatesAddlInfo> fetchAll(ResultSet rs) throws SQLException{
        List<IcRatesAddlInfo> list = new ArrayList<IcRatesAddlInfo>();
        while (rs.next()){
    ...
    public void populateParent(IcRatesAddlInfo icRatesAddlInfo) throws SQLException {
    }

    public void populateChild(IcRatesAddlInfo icRatesAddlInfo) throws SQLException {
    }

    public void populateAll(IcRatesAddlInfo icRatesAddlInfo) throws SQLException {
        populateParent(icRatesAddlInfo);
        populateChild(icRatesAddlInfo);
    }
    public int deleteAllBy(String prmCd ,String ratePlanCode) throws SQLException {
        Statement stmt = null;
        String SQL_STATEMENT ="delete ic_rates_addl_info where substr(DESTINATION_CD,1,2)= '"+prmCd+"' and RATE_PLAN_CD= '"+ratePlanCode+"'  ";
        try {
            stmt = getPrmConnection().createStatement();
            int status = stmt.executeUpdate(SQL_STATEMENT);
            log.info("DELETE ic_rates_addl_info SUCCESS");
            return status;
        } catch (SQLException ex) {
            ex.printStackTrace();
            log.error("DELETE ic_rates_addl_info FAIL");
            log.error(ex.toString());
        } catch (Exception ex) {
            ex.printStackTrace();
            log.error("DELETE ic_rates_addl_info FAIL");
